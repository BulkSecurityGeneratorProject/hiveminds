(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('natureexclusiveApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-natureexclusiveApp-error');
                var entityKey = httpResponse.headers('X-natureexclusiveApp-params');
                if (errorHeader) {
